...
function Carousel({
	...
	return (
		<CarouselContext.Provider value={contextValue}>
			{/* biome-ignore lint/a11y/useSemanticElements: carousel ARIA pattern requires role="region" with aria-roledescription */}
			<div
...
function CarouselItem({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: slide ARIA pattern requires role="group" with aria-roledescription
		<div
			role="group"
