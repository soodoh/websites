...
function SheetHeader({
  ...
  const classes: string = cn("flex flex-col gap-1.5 p-4", className);
...
function SheetFooter({
  ...
  const classes: string = cn("mt-auto flex flex-col gap-2 p-4", className);
...
function SheetTitle({
  ...
  const classes: string = cn("text-foreground font-semibold", className);
