...
function Carousel({
	...
	return (
		<CarouselContext.Provider value={contextValue}>
			{/* biome-ignore lint/a11y/useSemanticElements: carousel uses custom ARIA roledescription */}
			<div
...
function CarouselItem({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: slide uses custom ARIA roledescription
		<div
			role="group"
