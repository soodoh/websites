...
- `tests/` contains Vitest unit coverage plus Playwright interaction, smoke, and visual coverage.
...
- `bun run test:unit`: all Vitest tests named `*.test.ts(x)`.
- `bun run test:genealogy`: focused Vitest genealogy parser and input tests.
